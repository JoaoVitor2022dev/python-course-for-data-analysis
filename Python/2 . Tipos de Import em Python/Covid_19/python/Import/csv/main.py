...
covid_sp = pd.read_csv(
    r'C:\HD\ESTUDOS EM GERAL GRADE 1 SEMENTRES 2025\Curso de Python Analise de Dados\1 . Fundamentos em Python\Code Python\Python\Python\Import\Covid_19\database\dados_covid_sp.csv',
    sep=';', 
    encoding='utf-8'
)
